...
class RepositoryOfLocationXmlImplTest {
    private static RepositoryOfLocationXmlImpl repositoryOfLocationMemory;

    @BeforeEach
    void setUp() {
        repositoryOfLocationMemory = (RepositoryOfLocationXmlImpl) RepositoryOfLocationXmlImpl.getInstance();
    }
